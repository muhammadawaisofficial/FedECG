...
# Paths
MODEL_PATH = r"D:\Engr GHANWA MS 220211001\ADDITIONAL FED AGGREGATION METHODS\FEDERATED_LEARNING_FED_Adam_3_classes_Reducing_complexity_balanced\saved_models\best_fedadam_model.pth"
RESULTS_DIR = r"D:\Engr GHANWA MS 220211001\ADDITIONAL FED AGGREGATION METHODS\FEDERATED_LEARNING_FED_Adam_3_classes_Reducing_complexity_balanced\results"
...
def main():
    ...
    print("\n🌍 Evaluating combined test set...")
    combined_f1 = f1_score(all_y_true, all_y_pred, average="weighted")
    save_confusion_and_report(all_y_true, all_y_pred, "Combined_Test")
    print(f"Combined Test Weighted F1: {combined_f1:.4f}")
    ...
    with open(f1_path, "w") as f:
        ...
        f.write(f"\nCombined Test Weighted F1: {combined_f1:.4f}\n")
